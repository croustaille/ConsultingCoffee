...
/**
 * HotideasTranslation filter form base class.
 *
 ...
 */
abstract class BaseHotideasTranslationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('hotideas_translation_filters[%s]');
