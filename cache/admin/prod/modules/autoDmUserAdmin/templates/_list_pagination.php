...
<?php if ($pager->getPage() > 2): ?>
  <a title="<?php echo __('First page'); ?>" href="<?php echo url_for1('dm_user') ?>?page=1">
...
<?php endif; ?>
  ...
  <a title="<?php echo __('Previous page'); ?>" href="<?php echo url_for1('dm_user') ?>?page=<?php echo ($pager->getPage() - 1) ?>">
...
<?php if ($pager->getPage() < $pager->getLastPage()): ?>
  <a title="<?php echo __('Next page'); ?>" href="<?php echo url_for1('dm_user') ?>?page=<?php echo ($pager->getPage() + 1) ?>">
    <span class="s16block s16_next">&nbsp;</span>
  </a>

<?php if ($pager->getPage() < ($pager->getLastPage()-1)): ?>
  <a title="<?php echo __('Last page'); ?>" href="<?php echo url_for1('dm_user') ?>?page=<?php echo $pager->getLastPage() ?>">
