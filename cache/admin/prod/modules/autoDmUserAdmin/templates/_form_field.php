...
<?php if ($field->isPartial()): ?>
  <div class="<?php echo $divClass ?>"><?php include_partial('dmUserAdmin/'.$name, array('dmUser' => $form->getObject(), 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?></div>
<?php elseif ($field->isComponent()): ?>
  <div class="<?php echo $divClass ?>"><?php include_component('dmUserAdmin', $name, array('dmUserAdmin' => $form->getObject(), 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?></div>
