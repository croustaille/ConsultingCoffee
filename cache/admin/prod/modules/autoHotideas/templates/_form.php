...
<div class="sf_admin_form">
  ...
  <?php $formActions = get_partial('hotideas/form_action_bar'.(sfConfig::get('dm_admin_embedded') ? '_embedded' : ''), array('hotideas' => $hotideas, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper, 'nearRecords' => $nearRecords)); ?>
  ...
  <div class="dm_form_action_bar dm_form_action_bar_top clearfix">
    ...
    <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
      <?php include_partial('hotideas/form_fieldset', array('hotideas' => $hotideas, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
    <?php endforeach; ?>
