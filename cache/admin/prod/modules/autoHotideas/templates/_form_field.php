...
<?php if ($field->isPartial()): ?>
  <div class="<?php echo $divClass ?>"><?php include_partial('hotideas/'.$name, array('hotideas' => $form->getObject(), 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?></div>
<?php elseif ($field->isComponent()): ?>
  <div class="<?php echo $divClass ?>"><?php include_component('hotideas', $name, array('hotideas' => $form->getObject(), 'form' => $form, 'attributes' => $attributes instanceof sfOutputEscaper ? $attributes->getRawValue() : $attributes)) ?></div>
