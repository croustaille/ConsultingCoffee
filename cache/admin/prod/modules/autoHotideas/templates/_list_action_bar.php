...
<?php include_partial('hotideas/list_batch_actions', array('helper' => $helper)) ?>

<?php // LIENS  ?>

<?php include_partial('hotideas/list_actions', array('helper' => $helper, 'configuration' => $configuration)) ?>

<?php //PAGINATION ?>

<?php include_partial('hotideas/list_pagination', array('helper' => $helper, 'pager' => $pager)) ?>
