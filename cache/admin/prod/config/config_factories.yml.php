...
// date: 2011/06/23 19:13:04
  ...
  {
    $class = sfConfig::get('sf_factory_i18n', 'dmAdminI18n');
    $cache = new dmMetaCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\development\\sfprojects\\ConsultingCoffee\\cache\\admin\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\development\\sfprojects\\ConsultingCoffee\\apps\\admin/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'dmAdminRouting');
      $cache = new dmMetaCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\development\\sfprojects\\ConsultingCoffee\\cache\\admin\\prod\\config/routing',
  'lifetime' => 31556926,
  'prefix' => 'C:\\development\\sfprojects\\ConsultingCoffee\\apps\\admin/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\development\\sfprojects\\ConsultingCoffee\\cache\\admin\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\development\\sfprojects\\ConsultingCoffee\\apps\\admin/template',
)));
