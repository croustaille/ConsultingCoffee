...
<div id="sf_admin_container">
  <h1><?php echo __('City List', array(), 'messages') ?></h1>
  ...
  <div id="sf_admin_content">
    ...
    <ul class="sf_admin_actions">
      <?php include_partial('city/list_batch_actions', array('helper' => $helper)) ?>
      <?php include_partial('city/list_actions', array('helper' => $helper)) ?>
    </ul>
    </form>
  </div>
